...
namespace Line_Comparision
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double x1 = Convert.ToInt32(first_Point[0]);
            double y1 = Convert.ToInt32(first_Point[1]);
            Console.WriteLine("Enter the co-ordinates of other end in x,y format");
            string[] second_Point = (Console.ReadLine()).Split(",");
            double x2 = Convert.ToInt32(second_Point[0]);
            double y2 = Convert.ToInt32(second_Point[1]);
